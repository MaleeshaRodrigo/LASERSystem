...
Public Class TransactionDatabase
    ...
    Public Overrides Function Execute(Query As String, Optional Parameters As MySqlParameter() = Nothing, Optional AdminPer As AdminPermission = Nothing) As Integer
        If Transaction Is Nothing Then
