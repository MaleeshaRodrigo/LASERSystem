...
Public Class ControlStockInfo
    ...
    Private Sub CmbCategory_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CmbCategory.SelectedIndexChanged
        ComboBoxDropDown(Db, CmbName, $"SELECT {StructureDatabase.Stock.Name} FROM {StructureDatabase.Tables.Stock} WHERE {StructureDatabase.Stock.Category} = '{CmbCategory.Text}' GROUP BY {StructureDatabase.Stock.Name};")
    End Sub
End Class
